  ...
  def render("index.atom", %{conn: conn, posts: posts, current_blog: current_blog}) do
    {
      ...
      [
        {:id, nil, "#{root_url(conn, current_blog)}feed.atom"},
        title(current_blog),
      ...
      [
        {
          ...
          [
            ...
            {:link, nil, "#{root_url(conn, current_blog)}feed.rss"},
            {
              "atom:link",
              %{href: "#{root_url(conn, current_blog)}feed.rss", rel: "self", type: "application/rss+xml"},
              nil
            },
