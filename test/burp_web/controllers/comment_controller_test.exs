defmodule BurpWeb.CommentControllerTest do
  use BurpWeb.ConnCase

  alias Burp.Blog

  @create_attrs %{author: "some author", content: "some content", email: "some email", url: "some url", visible: true}
  @update_attrs %{author: "some updated author", content: "some updated content", email: "some updated email", url: "some updated url", visible: false}
  @invalid_attrs %{author: nil, content: nil, email: nil, url: nil, visible: nil}
